...
let questions = [
    ...
    options: [
      ...
      "C)Rememora la Reconquista de los Reyes Católicos en 1489 y la rendición de El Zagal",
    ...
    answer: "A)Se utilizaban como galerías para conducir y comunicar el agua entre las balsas principales y auxiliares que regulaban el agua",
    options: [
      "A)Se utilizaban como galerías para conducir y comunicar el agua entre las balsas principales y auxiliares que regulaban el agua",
    ...
    answer: "A)Fueron construidas en 1948 para solucionar la escasez de viviendas,reduciendo la calidad de los materiales",
    options: [
      "A)Fueron construidas en 1948 para solucionar la escasez de viviendas,reduciendo la calidad de los materiales",
    ...
    answer: "C)Porque fue construido gracias a la humanidad de la Reina Regente María Cristina tras la inundación de 1891",
    options: [
      ...
      "C)Porque fue construido gracias a la humanidad de la Reina Regente María Cristina tras la inundación de 1891",
  ...
  {
    numb: 9,
    question: "¿Por qué el edificio del Instituto del Celia Viñas tiene forma irregular?",
    ...
    options: [
      ...
      "B)Fue construido sobre un solar dedeicado al almacenamiento de munición en la guerra civil",
      "C)Fue contruido sobre un campo de entrenamiento",
      "D)Fue construido sobre el espacio que había"
    ]
  },
  {
    numb: 10,
    question: "¿Qué había en la Plaza Juan Casinello antes de ser la Plaza del Educador?",
    answer: "B)Parada de coches de caballos",
    options: [
      "A)Parada de coches",
      "B)Parada de coches de caballos",
