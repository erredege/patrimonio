    ...
    @isset($marker)
        ...
        @else
            ...
            <div class="form-group">
                ...
                @else
                    <input type="color" class="form-control " style="width: " name="background_color"
                        value="{{ $marker->background_color ?? '' }}">
                @endif
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="information" value="{{ $marker->information ?? '' }}"
                    size=20 style="height:250px">
            </div>
            <div class="form-group">
            ...
            function agregarPuntos() {
                if (document.getElementById('tipoPunto').value == 2) {
                    document.getElementById('pointPolygon').innerHTML =
                        " <label class='control-label'>Puntos para el poligono</label>";
                    document.getElementById('pointPolygon').innerHTML +=
                        "<input class='form-control' type='text' name='puntosPoligono' placeholder='latitud,longitud / latitud,longitud / ...'>";
                } else {
                    document.getElementById('pointPolygon').innerHTML = "";
                }
            }
